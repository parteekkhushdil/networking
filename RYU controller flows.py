...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def switch_features_handler(self, ev):
        ...
        if dpid == 1: # switch S1
            ...
            self.add_layer4_rules(datapath, inet.IPPROTO_TCP, '10.0.0.2', 10, 4)
	    ...
	    match = parser.OFPMatch(eth_type = ether.ETH_TYPE_IP,
            ...
            self.add_layer4_rules(datapath, inet.IPPROTO_TCP, '10.0.0.1', 10, 4)
            self.add_layer4_rules(datapath, inet.IPPROTO_TCP, '10.0.0.2', 10, 1)
            self.add_layer4_rules(datapath, inet.IPPROTO_TCP, '10.0.0.3', 10, 4)
            self.add_layer4_rules(datapath, inet.IPPROTO_TCP, '10.0.0.4', 10, 2)

            ### implement icmp fwding
            self.add_layer4_rules(datapath, inet.IPPROTO_ICMP, '10.0.0.1', 10, 4)
            self.add_layer4_rules(datapath, inet.IPPROTO_ICMP, '10.0.0.2', 10, 1)
            self.add_layer4_rules(datapath, inet.IPPROTO_ICMP, '10.0.0.3', 10, 4)
